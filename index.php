...
<body class="font-sans antialiased bg-navy">
    ...
    <section class="relative h-screen w-full overflow-hidden bg-navy">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center h-full px-4 sm:px-6">
            ...
            <div class="fade-up mb-7 inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-white/60 backdrop-blur-md border border-slate-200 shadow-xl shadow-black/5 rotate-3 hover:rotate-0 transition-transform duration-500" style="animation-delay: 0.05s;">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 sm:w-10 sm:h-10 text-blue-600 drop-shadow-sm" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <!-- Title -->
            <h1 class="fade-up max-w-4xl text-center font-black tracking-tight leading-[1.12] text-slate-900 drop-shadow-sm text-3xl sm:text-5xl lg:text-[3.6rem]" style="animation-delay: 0.25s;">
        ...
        <!-- Bottom edge fade removed for light theme -->
    </section>
