                                                    ...
                                                    <div class="actions flex gap-1">
                                                        ...
                                                        <?php if (checkPermission('units', 'delete')): ?>
                                                            <?php if ($u['product_count'] > 0): ?>
                                                                <button onclick="alert('Cannot delete this unit because it is used by <?= $u['product_count'] ?> product(s). Please change the products\' unit first.')" title="Cannot delete: Unit is in use" class="btn btn-sm bg-gray-100 text-gray-400 cursor-not-allowed rounded-lg">
