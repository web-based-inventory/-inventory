...
SELECT *, (SELECT COUNT(*) FROM purchases WHERE supplier_id = suppliers.id) as purchase_count 
FROM suppliers
                                            ...
                                            <div class="actions flex gap-1">
                                                ...
                                                <?php if (checkPermission('suppliers', 'delete')): ?>
                                                    <?php if ((int)$row['purchase_count'] > 0): ?>
                                                        <button onclick="alert('Cannot delete this supplier because they have <?= $row['purchase_count'] ?> purchase record(s).')" title="Cannot delete: Supplier has purchases" class="btn btn-sm bg-gray-100 text-gray-400 cursor-not-allowed rounded-lg">
